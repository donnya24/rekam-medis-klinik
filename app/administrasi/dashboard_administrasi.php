...
include "../../includes/administrasi/header.php";
...
// Query Total Reservasi Hari Ini
...
$query_reservasi_hari_ini = mysqli_query($conn, "
    ...
    WHERE r.tanggal = '$tanggal_hari_ini'
");

// Query Transaksi Pembayaran Terbaru
...
// Query Laporan Transaksi Perawatan Bulan Ini
$bulan_ini = date('Y-m');
$query_perawatan_bulan_ini = mysqli_query($conn, "
    ...
    WHERE DATE_FORMAT(tp.tanggal, '%Y-%m') = '$bulan_ini'
");
?>
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="panel panel-success">
                        <div class="panel-heading">Total Reservasi Hari Ini</div>
                        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">Daftar Reservasi Pasien dengan Dokter Hari Ini</div>
                        <div class="panel-body">
                            <table class="table table-bordered table-striped">
                                <thead class="bg-primary text-white">
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($query_reservasi_hari_ini) > 0) {
                                        ...
                                        echo "<tr><td colspan='5' style='text-align: center;'>Tidak ada reservasi hari ini</td></tr>";
                                    }
                                    ?>
                                </tbody>
                            </table>
                        ...
                        <tbody>
                            ...
                            if (mysqli_num_rows($query_pembayaran_terbaru) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($query_pembayaran_terbaru)) {
                                    ...
                                    echo "<td>" . $no . "</td>";
                                    echo "<td>" . htmlspecialchars($row['nama_pasien']) . "</td>";
                                    // Format total_harga ke dalam Rupiah
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                    if (mysqli_num_rows($query_perawatan_bulan_ini) > 0) {
                                        $no = 1;
                                        while ($row = mysqli_fetch_assoc($query_perawatan_bulan_ini)) {
                                            echo "<tr>";
                                            echo "<td>" . $no . "</td>";
                                            echo "<td>" . htmlspecialchars($row['nama_pasien']) . "</td>";

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['update_profile'])) {
        ...
        if ($stmt->execute()) {
            echo "<script>alert('Profil berhasil diperbarui!'); window.location.href='dashboard_administrasi.php';</script>";
        } else {
        ...
        if ($password_lama !== $user['password']) {
            ...
            if ($stmt->execute()) {
                echo "<script>alert('Password berhasil diubah!'); window.location.href='dashboard_administrasi.php';</script>";
            } else {
    ...
    <div class="main-container">
        <div class="profile-card">
            ...
            <form method="POST">
                ...
                <div class="btn-group">
                    <a href="dashboard_administrasi.php" class="btn btn-secondary">Kembali</a>
